	...
	<view class="uni-searchbar">
		<view :style="{borderRadius:radius+'px',backgroundColor: bgColor}" class="uni-searchbar__box" @click="searchClick">
			...
			<view class="uni-searchbar__box-icon-search">
				<uni-icons color="grey" size="18" type="search" />
			</view>
			<!-- #endif -->
			<!-- #ifndef MP-ALIPAY -->
			<uni-icons color="grey" class="uni-searchbar__box-icon-search" size="18" type="search" />
			<!-- #endif -->
			...
			<view v-if="show && (clearButton==='always'||clearButton==='auto'&&searchVal!=='')" class="uni-searchbar__box-icon-clear" @click="clear">
				<uni-icons color="grey" class="" size="24" type="clear" />
			</view>
		</view>
