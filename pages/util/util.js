export function request(params = {},name) {
...
/**
	 ...
	 * @return String 名字
*/
export function randomName(simple,len) {
	let name = ''
	const surName = [
	...
	let surNameLen = surName.length
	let doubleSurNameLen = doubleSurName.length
...
* 格式化时间
* */
export function myformatter(date){  
